        ...
        <div class="flex justify-center md:justify-end">
            <div class="w-full max-w-[480px] bg-surface-container-lowest p-6 md:p-8 rounded-xl shadow-[0_20px_40px_rgba(0,7,103,0.06)] border border-outline-variant/15">
                ...
                <div class="space-y-4">
                    ...
                    <!-- Google Auth Button -->
                    <button onclick="window.location.href='/auth/google'" class="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-surface-container-lowest border border-outline-variant/30 rounded-lg text-on-surface-variant font-medium hover:bg-surface-container-low transition-all duration-150">
